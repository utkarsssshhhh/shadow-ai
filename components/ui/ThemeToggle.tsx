...
export default function ThemeToggle() {
  ...
  // 1. On Mount: Check system preference or saved setting
  useEffect(() => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-3 rounded-full bg-white/50 dark:bg-neutral-800/50 backdrop-blur-md shadow-sm border border-white/50 dark:border-white/10 text-stone-600 dark:text-stone-300 transition-all hover:scale-110 active:scale-95"
